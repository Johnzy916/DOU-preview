...
},{"react-refresh/runtime":"786KC"}],"edn9Z":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "928f63c6e784119e";
...
},{}],"fxOUS":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$393a = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$393a.prelude(module);
...
var _notesToolbar = require("./NotesToolbar");
var _shortcuts = require("./Shortcuts");
var _trackTyping = require("../utils/trackTyping");
var _changeText = require("../utils/changeText");
...
_reactQuill.Quill.debug('error');
// switch Quill default block to Div to avoid 
// extra lines being added when pasted into plain text areas
var Block = _reactQuill.Quill.import('blots/block');
Block.tagName = 'DIV';
_reactQuill.Quill.register(Block, true);
// register the clipboard module for pasting plain text
_reactQuill.Quill.register({
    "modules/clipboard": _clipboard.PlainClipboard
}, true);
function Notes() {
    _s();
    const { state , notesDispatch  } = _react.useContext(_stateContext.StateContext);
    const editorRef = _react.useRef();
    ...
    _react.useEffect(async ()=>{
        // static snippets
        const snippets = await _getStaticDataDefault.default('snippets.json', 'Unable to load snippets', 'Please reload the page');
        notesDispatch({
            type: 'SET_SNIPPETS',
            snippets
        });
    ...
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
        ...
        onCopy: (e)=>{
            e.preventDefault();
            e.stopPropagation();
            _clipboard.handleCopyTextSelection(editorRef);
        },
        onCut: (e)=>{
            e.preventDefault();
            e.stopPropagation();
            _clipboard.handleCutTextSelection(editorRef);
        },
        children: [
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_notesToolbar.NotesToolbar, {
                editorRef: editorRef
            }, void 0, false, {
                fileName: "src/js/components/Notes.js",
                lineNumber: 105,
                columnNumber: 13
            }, this),
            state.showShortcuts && /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_shortcuts.Shortcuts, {
            ...
            !state.showShortcuts && /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_reactQuillDefault.default, {
                value: state.notesValue,
                onChange: (content, delta, source, editor)=>{
                    return handleChange(content, delta, source, editor);
                },
                onKeyUp: (e)=>_trackTyping.trackTyping(e, editorRef, state.snippets, state.customSnippets)
                ,
                onKeyDown: (e)=>_changeText.formatPhoneNumber(e, editorRef)
                ,
                theme: "snow",
                modules: modules,
                formats: formats,
...
_s(Notes, "V+84T39VPZhO23TZTqHUjhhZxBI=");
_c = Notes;
var _c;
$RefreshReg$(_c, "Notes");

  $parcel$ReactRefreshHelpers$393a.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","react-quill":"kyGm9","../context/StateContext":"W4FOM","./NotesToolbar":"1GvOx","./Shortcuts":"dlvZq","../utils/trackTyping":"ivZGd","../utils/changeText":"bvasa","../utils/Clipboard":"db1SM","../utils/getStaticData":"iWzMk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"kyGm9":[function(require,module,exports) {
"use strict";
/*
React-Quill
...
var ReactQuill = function(_super) {
    __extends(ReactQuill1, _super);
    function ReactQuill1(props) {
    ...
    ReactQuill1.prototype.validateProps = function(props) {
        var _a;
    ...
    ReactQuill1.prototype.shouldComponentUpdate = function(nextProps, nextState) {
        var _this = this;
        var _a;
    ...
    ReactQuill1.prototype.shouldComponentRegenerate = function(nextProps) {
        var _this = this;
    ...
    ReactQuill1.prototype.componentDidMount = function() {
        this.instantiateEditor();
        this.setEditorContents(this.editor, this.getEditorContents());
    };
    ReactQuill1.prototype.componentWillUnmount = function() {
        this.destroyEditor();
    };
    ReactQuill1.prototype.componentDidUpdate = function(prevProps, prevState) {
        var _this = this;
    ...
    ReactQuill1.prototype.instantiateEditor = function() {
        if (this.editor) this.hookEditor(this.editor);
        else this.editor = this.createEditor(this.getEditingArea(), this.getEditorConfig());
    };
    ReactQuill1.prototype.destroyEditor = function() {
        if (!this.editor) return;
        this.unhookEditor(this.editor);
    };
    /*
    We consider the component to be controlled if `value` is being sent in props.
    */ ReactQuill1.prototype.isControlled = function() {
        return 'value' in this.props;
    };
    ReactQuill1.prototype.getEditorConfig = function() {
        return {
    ...
    ReactQuill1.prototype.getEditor = function() {
    ...
    */ ReactQuill1.prototype.createEditor = function(element, config) {
    ...
    ReactQuill1.prototype.unhookEditor = function(editor) {
        editor.off('editor-change', this.onEditorChange);
    };
    ReactQuill1.prototype.getEditorContents = function() {
        return this.value;
    };
    ReactQuill1.prototype.getEditorSelection = function() {
        return this.selection;
    };
    /*
    True if the value is a Delta instance or a Delta look-alike.
    */ ReactQuill1.prototype.isDelta = function(value) {
        return value && value.ops;
    };
    /*
    Special comparison function that knows how to compare Deltas.
    */ ReactQuill1.prototype.isEqualValue = function(value, nextValue) {
    ...
    */ ReactQuill1.prototype.setEditorContents = function(editor, value) {
        var _this = this;
        this.value = value;
    ...
    ReactQuill1.prototype.setEditorSelection = function(editor, range) {
    ...
    ReactQuill1.prototype.setEditorTabIndex = function(editor, tabIndex) {
        var _a, _b;
        if ((_b = (_a = editor) === null || _a === void 0 ? void 0 : _a.scroll) === null || _b === void 0 ? void 0 : _b.domNode) editor.scroll.domNode.tabIndex = tabIndex;
    };
    ReactQuill1.prototype.setEditorReadOnly = function(editor, value) {
    ...
    */ ReactQuill1.prototype.makeUnprivilegedEditor = function(editor) {
        var e = editor;
        return {
            getHTML: function() {
    ...
    ReactQuill1.prototype.getEditingArea = function() {
    ...
    */ ReactQuill1.prototype.renderEditingArea = function() {
        var _this = this;
        ...
        return preserveWhitespace ? react_1.default.createElement("pre", __assign({
        }, properties)) : react_1.default.createElement("div", __assign({
        }, properties));
    };
    ReactQuill1.prototype.render = function() {
        var _a;
    ...
    ReactQuill1.prototype.onEditorChangeText = function(value, delta, source, editor) {
        var _a, _b;
        if (!this.editor) return;
    ...
    ReactQuill1.prototype.onEditorChangeSelection = function(nextSelection, source, editor) {
    ...
    ReactQuill1.prototype.focus = function() {
        if (!this.editor) return;
        this.editor.focus();
    };
    ReactQuill1.prototype.blur = function() {
        if (!this.editor) return;
        this.selection = null;
        this.editor.blur();
    };
    ReactQuill1.displayName = 'React Quill';
    /*
    Export Quill to be able to call `register`
    */ ReactQuill1.Quill = quill_1.default;
    ReactQuill1.defaultProps = {
        theme: 'snow',
        modules: {
        },
        readOnly: false
...
},{"react":"21dqq","react-dom":"j6uA9","lodash/isEqual":"9XEia","quill":"f8P8G"}],"9XEia":[function(require,module,exports) {
...
},{"./_getNative":"9PCIl","./_root":"dSYUs"}],"f8P8G":[function(require,module,exports) {
 ...
 */ (function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ })([
        ...
        function(module, exports, __webpack_require__) {
            ...
            var ParchmentError1 = function(_super) {
            ...
            exports.ParchmentError = ParchmentError1;
            var attributes = {
            };
            var classes = {
            };
            ...
            })(Scope1 = exports.Scope || (exports.Scope = {
            }));
            function create(input, value) {
                var match = query1(input);
                if (match == null) throw new ParchmentError1("Unable to create " + input + " blot");
                var BlotClass = match;
                var node = // @ts-ignore
            ...
            exports.find = find;
            function query1(query, scope) {
                if (scope === void 0) scope = Scope1.ANY;
                var match;
                if (typeof query === 'string') match = types[query] || attributes[query];
                    ...
                    if (query & Scope1.LEVEL & Scope1.BLOCK) match = types['block'];
                    else if (query & Scope1.LEVEL & Scope1.INLINE) match = types['inline'];
                ...
                // @ts-ignore
                if (scope & Scope1.LEVEL & match.scope && scope & Scope1.TYPE & match.scope) return match;
                return null;
            }
            ...
            function register() {
                ...
                if (typeof Definition.blotName !== 'string' && typeof Definition.attrName !== 'string') throw new ParchmentError1('Invalid definition');
                else if (Definition.blotName === 'abstract') throw new ParchmentError1('Cannot register abstract class');
        ...
        function(module, exports, __webpack_require__) {
            ...
            var op1 = __webpack_require__(20);
            ...
            Delta.prototype.changeLength = function() {
                return this.reduce(function(length, elem) {
                    if (elem.insert) return length + op1.length(elem);
            ...
            Delta.prototype.slice = function(start, end) {
                ...
                var ops = [];
                var iter = op1.iterator(this.ops);
                var index = 0;
                while(index < end && iter.hasNext()){
                    ...
                    index += op1.length(nextOp);
                }
                return new Delta(ops);
            };
            Delta.prototype.compose = function(other) {
                var thisIter = op1.iterator(this.ops);
                var otherIter = op1.iterator(other.ops);
                var ops = [];
                ...
                while(thisIter.hasNext() || otherIter.hasNext()){
                    if (otherIter.peekType() === 'insert') delta.push(otherIter.next());
                        ...
                        if (typeof otherOp.retain === 'number') {
                            ...
                            var attributes = op1.attributes.compose(thisOp.attributes, otherOp.attributes, typeof thisOp.retain === 'number');
                    ...
                    while(length > 0){
                        ...
                        switch(component[0]){
                            case diff.INSERT:
                                ...
                                delta1.push(otherIter.next(opLength));
                                break;
                            case diff.DELETE:
                                opLength = Math.min(length, thisIter.peekLength());
                                thisIter.next(opLength);
                                delta1['delete'](opLength);
                                break;
                            case diff.EQUAL:
                                opLength = Math.min(thisIter.peekLength(), otherIter.peekLength(), length);
                                var thisOp = thisIter.next(opLength);
                                var otherOp = otherIter.next(opLength);
                                if (equal(thisOp.insert, otherOp.insert)) delta1.retain(opLength, op1.attributes.diff(thisOp.attributes, otherOp.attributes));
                                else delta1.push(otherOp)['delete'](opLength);
                                break;
                        }
                        length -= opLength;
                    }
            ...
            Delta.prototype.eachLine = function(predicate, newline) {
                ...
                while(iter.hasNext()){
                    ...
                    var start = op1.length(thisOp) - iter.peekLength();
            ...
            Delta.prototype.transform = function(other, priority) {
                ...
                var delta = new Delta();
                while(thisIter.hasNext() || otherIter.hasNext()){
                    if (thisIter.peekType() === 'insert' && (priority || otherIter.peekType() !== 'insert')) delta.retain(op1.length(thisIter.next()));
                        ...
                        else // We retain either their retain or insert
                        delta.retain(length, op1.attributes.transform(thisOp.attributes, otherOp.attributes, priority));
                    }
                }
                return delta.chop();
            };
        ...
        function(module, exports, __webpack_require__) {
            ...
            var BlockEmbed1 = function(_Parchment$Embed) {
                    ...
                    },
                    {
                        ...
                        value: function insertAt(index, value, def) {
                            if (typeof value === 'string' && value.endsWith('\n')) {
                                var block = _parchment2.default.create(Block1.blotName);
            ...
            BlockEmbed1.scope = _parchment2.default.Scope.BLOCK_BLOT;
            // It is important for cursor behavior BlockEmbeds use tags that are block level elements
            var Block1 = function(_Parchment$Block) {
                ...
                _createClass(Block, [
                    ...
                    {
                        key: 'insertAt',
                        value: function insertAt(index1, value, def) {
                            if (def != null) return _get(Block.prototype.__proto__ || Object.getPrototypeOf(Block.prototype), 'insertAt', this).call(this, index1, value, def);
                            if (value.length === 0) return;
                            var lines = value.split('\n');
                            var text = lines.shift();
                            if (text.length > 0) {
                                if (index1 < this.length() - 1 || this.children.tail == null) _get(Block.prototype.__proto__ || Object.getPrototypeOf(Block.prototype), 'insertAt', this).call(this, Math.min(index1, this.length() - 1), text);
            ...
            Block1.blotName = 'block';
            Block1.tagName = 'P';
            Block1.defaultChild = 'break';
            Block1.allowedChildren = [
                _inline2.default,
                _parchment2.default.Embed,
                _text2.default
            ];
            ...
            exports.BlockEmbed = BlockEmbed1;
        ...
        function(module, exports, __webpack_require__) {
                    ...
                    },
                    {
                        ...
                        value: function format(name, value) {
                            ...
                            return modify.call(this, function() {
                                ...
                                else if (_parchment2.default.query(name, _parchment2.default.Scope.BLOCK)) change = _this4.editor.formatLine(range.index, range.length, _defineProperty({
                                }, name, value));
                                else if (range.length === 0) {
                                    _this4.selection.format(name, value);
                                    return change;
                                } else change = _this4.editor.formatText(range.index, range.length, _defineProperty({
                                }, name, value));
            ...
            Quill1.events = _emitter4.default.events;
            Quill1.sources = _emitter4.default.sources;
            // eslint-disable-next-line no-undef
            Quill1.version = "1.3.7";
            Quill1.imports = {
            ...
            function expandConfig(container, userConfig) {
                ...
                if (!userConfig.theme || userConfig.theme === Quill1.DEFAULTS.theme) userConfig.theme = _theme2.default;
                else {
                    userConfig.theme = Quill1.import('themes/' + userConfig.theme);
                ...
                [
                    ...
                    Object.keys(config.modules).forEach(function(module) {
                        if (config.modules[module] === true) config.modules[module] = {
                        };
                    });
                });
                var moduleNames = Object.keys(themeConfig.modules).concat(Object.keys(userConfig.modules));
                var moduleConfig = moduleNames.reduce(function(config, name) {
                    var moduleClass = Quill1.import('modules/' + name);
                ...
                if (userConfig.modules != null && userConfig.modules.toolbar && userConfig.modules.toolbar.constructor !== Object) userConfig.modules.toolbar = {
            ...
            function overload(index, length, name, value, source) {
                ...
                if (typeof index.index === 'number' && typeof index.length === 'number') {
                    ...
                    if (typeof length !== 'number') source = value, value = name, name = length, length = index.length, index = index.index;
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Inline1 = function(_Parchment$Inline) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var TextBlot1 = function(_Parchment$Text) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Emitter1 = function(_EventEmitter) {
                    ...
                    },
                    {
                        ...
                        value: function handleDOM(event) {
                            ...
                            (this.listeners[event.type] || []).forEach(function(_ref) {
                                ...
                                if (event.target === node || node.contains(event.target)) handler.apply(undefined, [
                                    event
                                ].concat(args));
                            });
                        }
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Module1 = function Module(quill) {
                var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
                };
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Attributor1 = function() {
                function Attributor(attrName, keyName, options) {
                    ...
                    if (options.scope != null) // Ignore type bits, force attribute bit
        ...
        function(module, exports, __webpack_require__) {
            ...
            Code1.blotName = 'code';
            Code1.tagName = 'CODE';
            var CodeBlock1 = function(_Block) {
        ...
        function(module, exports, __webpack_require__) {
                ...
                _createClass(Editor, [
                    ...
                    },
                    {
                        ...
                        value: function insertEmbed(index, embed, value) {
                            ...
                            return this.update(new _quillDelta2.default().retain(index).insert(_defineProperty({
                            }, embed, value)));
                        }
                    },
                    {
            ...
            function combineFormats(formats, combined) {
                return Object.keys(combined).reduce(function(merged, name) {
                    ...
                    if (combined[name] === formats[name]) merged[name] = combined[name];
                        ...
                        if (combined[name].indexOf(formats[name]) < 0) merged[name] = combined[name].concat([
                            formats[name]
                        ]);
                    } else merged[name] = [
                        combined[name],
            ...
            function normalizeDelta(delta4) {
                return delta4.reduce(function(delta, op) {
                    if (op.insert === 1) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Range1 = function Range(index) {
                var length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            ...
            var Selection1 = function() {
                function Selection(scroll, emitter) {
                    ...
                    this.lastRange = this.savedRange = new Range1(0, 0);
                ...
                _createClass(Selection, [
                    ...
                    },
                    {
                        ...
                        value: function format(_format, value) {
                            ...
                            if (nativeRange.start.node !== this.cursor.textNode) {
                                ...
                                } else blot.insertBefore(this.cursor, nativeRange.start.node); // Should never happen
                                this.cursor.attach();
                            }
                    ...
                    },
                    {
                        ...
                        value: function normalizedToRange(range) {
                            ...
                            return new Range1(start, end - start);
                        }
                    },
                    {
                        key: 'normalizeNative',
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Break1 = function(_Parchment$Embed) {
            ...
            Break1.blotName = 'break';
            Break1.tagName = 'BR';
            exports.default = Break1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || function() {
            ...
            var Registry = __webpack_require__(1);
            var ContainerBlot1 = function(_super) {
                ...
                ContainerBlot.prototype.deleteAt = function(index, length1) {
                    if (index === 0 && length1 === this.length()) return this.remove();
                    this.children.forEachAt(index, length1, function(child, offset, length) {
                        child.deleteAt(offset, length);
                    });
                };
                ContainerBlot.prototype.descendant = function(criteria, index) {
                    var _a = this.children.find(index), child = _a[0], offset = _a[1];
                    if (criteria.blotName == null && criteria(child) || criteria.blotName != null && child instanceof criteria) return [
                        child,
                        offset
                    ];
                ...
                ContainerBlot.prototype.descendants = function(criteria, index2, length2) {
                    if (index2 === void 0) index2 = 0;
                    if (length2 === void 0) length2 = Number.MAX_VALUE;
                    var descendants = [];
                    var lengthLeft = length2;
                    this.children.forEachAt(index2, length2, function(child, index, length) {
                ...
                ContainerBlot.prototype.formatAt = function(index, length3, name, value) {
                    this.children.forEachAt(index, length3, function(child, offset, length) {
                ...
                ContainerBlot.prototype.path = function(index, inclusive) {
                    ...
                    else if (child != null) position.push([
                        child,
                        offset
                    ]);
                    return position;
            ...
            exports.default = ContainerBlot1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || function() {
            ...
            var container_1 = __webpack_require__(17);
            var Registry = __webpack_require__(1);
            var FormatBlot1 = function(_super) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var LeafBlot1 = function(_super) {
                ...
                LeafBlot.prototype.value = function() {
                    var _a;
                    return _a = {
                    }, _a[this.statics.blotName] = this.statics.value(this.domNode) || true, _a;
                };
                LeafBlot.scope = Registry.Scope.INLINE_BLOT;
                return LeafBlot;
            }(shadow_1.default);
            exports.default = LeafBlot1;
        /***/ },
        function(module, exports, __webpack_require__) {
            var equal = __webpack_require__(11);
            var extend = __webpack_require__(3);
            var lib = {
                attributes: {
                    ...
                    diff: function(a, b) {
                        ...
                        var attributes1 = Object.keys(a).concat(Object.keys(b)).reduce(function(attributes, key) {
                            if (!equal(a[key], b[key])) attributes[key] = b[key] === undefined ? null : b[key];
                            return attributes;
                        }, {
                        });
                        return Object.keys(attributes1).length > 0 ? attributes1 : undefined;
                    },
                    transform: function(a, b, priority) {
                        if (typeof a !== 'object') return b;
                        if (typeof b !== 'object') return undefined;
                        if (!priority) return b; // b simply overwrites us without priority
                        var attributes2 = Object.keys(b).reduce(function(attributes, key) {
                            if (a[key] === undefined) attributes[key] = b[key]; // null is a valid value
                            return attributes;
                        }, {
                        });
                        return Object.keys(attributes2).length > 0 ? attributes2 : undefined;
                    }
                },
            ...
            Iterator.prototype.peekType = function() {
                if (this.ops[this.index]) {
                    if (typeof this.ops[this.index]['delete'] === 'number') return 'delete';
 ...
 */ clone.clonePrototype = function clonePrototype(parent) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Scroll1 = function(_Parchment$Scroll) {
                ...
                _createClass(Scroll, [
                    ...
                    {
                        key: 'lines',
                        value: function lines1() {
                            var index3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
                            var length4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Number.MAX_VALUE;
                            var getLines1 = function getLines(blot, index4, length5) {
                                var lines = [], lengthLeft = length5;
                                blot.children.forEachAt(index4, length5, function(child, index, length) {
                            ...
                            return getLines1(this, index3, length4);
                        }
                    },
                    {
                        key: 'optimize',
            ...
            Scroll1.blotName = 'scroll';
            Scroll1.className = 'ql-editor';
            Scroll1.tagName = 'DIV';
            Scroll1.defaultChild = 'block';
            Scroll1.allowedChildren = [
                _block2.default,
                _block.BlockEmbed,
                _container2.default
            ];
            exports.default = Scroll1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
            ...
            var Keyboard1 = function(_Module) {
            ...
            Keyboard1.DEFAULTS = {
                bindings: {
                    ...
                    'embed left': makeEmbedArrowHandler(Keyboard1.keys.LEFT, false),
                    'embed left shift': makeEmbedArrowHandler(Keyboard1.keys.LEFT, true),
                    'embed right': makeEmbedArrowHandler(Keyboard1.keys.RIGHT, false),
                    'embed right shift': makeEmbedArrowHandler(Keyboard1.keys.RIGHT, true)
                }
            };
            function makeEmbedArrowHandler(key, shiftKey) {
                var _ref3;
                var where = key === Keyboard1.keys.LEFT ? 'prefix' : 'suffix';
                return _ref3 = {
                    key: key,
                    shiftKey: shiftKey,
                    altKey: null
                    ...
                    if (key === Keyboard1.keys.RIGHT) index += range.length + 1;
                    ...
                    if (key === Keyboard1.keys.LEFT) {
                        if (shiftKey) this.quill.setSelection(range.index - 1, range.length + 1, _quill2.default.sources.USER);
            ...
            function handleEnter(range, context) {
                var _this3 = this;
                if (range.length > 0) this.quill.scroll.deleteAt(range.index, range.length); // So we do not trigger text-change
                var lineFormats1 = Object.keys(context.format).reduce(function(lineFormats, format) {
                ...
                this.quill.insertText(range.index, '\n', lineFormats1, _quill2.default.sources.USER);
                // Earlier scroll.deleteAt might have messed up our selection,
                // so insertText's built in selection preservation is not reliable
                this.quill.setSelection(range.index + 1, _quill2.default.sources.SILENT);
                this.quill.focus();
                Object.keys(context.format).forEach(function(name) {
                    if (lineFormats1[name] != null) return;
            ...
            function normalize(binding) {
                if (typeof binding === 'string' || typeof binding === 'number') return normalize({
                    key: binding
                });
                if ((typeof binding === 'undefined' ? 'undefined' : _typeof(binding)) === 'object') binding = (0, _clone2.default)(binding, false);
                if (typeof binding.key === 'string') {
                    if (Keyboard1.keys[binding.key.toUpperCase()] != null) binding.key = Keyboard1.keys[binding.key.toUpperCase()];
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Cursor1 = function(_Parchment$Embed) {
            ...
            Cursor1.blotName = 'cursor';
            Cursor1.className = 'ql-cursor';
            Cursor1.tagName = 'span';
            Cursor1.CONTENTS = '\uFEFF'; // Zero width no break space
            exports.default = Cursor1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
            ...
            var Container1 = function(_Parchment$Container) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var ColorAttributor1 = function(_Parchment$Attributor) {
            ...
            var ColorStyle = new ColorAttributor1('color', 'color', {
                scope: _parchment2.default.Scope.INLINE
            });
            exports.ColorAttributor = ColorAttributor1;
        ...
        function(module, exports, __webpack_require__) {
            ...
            Link1.blotName = 'link';
            Link1.tagName = 'A';
            Link1.SANITIZED_URL = 'about:blank';
            Link1.PROTOCOL_WHITELIST = [
                'http',
                'https',
                'mailto',
                'tel'
        ...
        function(module, exports, __webpack_require__) {
            ...
            var ShadowBlot1 = function() {
                ...
                ShadowBlot.prototype.optimize = function(context) {
                    ...
                    // @ts-ignore
                    if (this.domNode[Registry.DATA_KEY] != null) // @ts-ignore
        ...
        function(module, exports, __webpack_require__) {
            ...
            exports.default = AttributorStore1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || function() {
            ...
            var ClassAttributor1 = function(_super) {
            ...
            exports.default = ClassAttributor1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || function() {
            ...
            var StyleAttributor1 = function(_super) {
            ...
            exports.default = StyleAttributor1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var GUARD_TEXT = '\uFEFF';
            var Embed1 = function(_Parchment$Embed) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var FontStyleAttributor1 = function(_Parchment$Attributor) {
            ...
            var FontStyle = new FontStyleAttributor1('font', 'font-family', config);
        ...
        function(module1, exports, __webpack_require__) {
            ...
            var BaseTheme1 = function(_Theme) {
                _inherits(BaseTheme, _Theme);
                function BaseTheme(quill, options) {
                    _classCallCheck(this, BaseTheme);
                    var _this = _possibleConstructorReturn(this, (BaseTheme.__proto__ || Object.getPrototypeOf(BaseTheme)).call(this, quill, options));
                    var listener1 = function listener(e) {
                    ...
                    quill.emitter.listenDOM('click', document.body, listener1);
                    return _this;
                }
            ...
            BaseTheme1.DEFAULTS = (0, _extend2.default)(true, {
            ...
            var BaseTooltip1 = function(_Tooltip) {
            ...
            exports.BaseTooltip = BaseTooltip1;
            exports.default = BaseTheme1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var ScrollBlot1 = function(_super) {
                ...
                ScrollBlot.prototype.optimize = function(mutations, context) {
                    ...
                    var mark = function(blot, markParent) {
                        ...
                        // @ts-ignore
                        if (blot.domNode[Registry.DATA_KEY].mutations == null) // @ts-ignore
                    ...
                    var optimize = function(blot) {
                        ...
                        blot.domNode[Registry.DATA_KEY].mutations == null) return;
                ...
                ScrollBlot.prototype.update = function(mutations, context) {
                    ...
                    // @ts-ignore
                    if (this.domNode[Registry.DATA_KEY].mutations != null) // @ts-ignore
        ...
        function(module, exports, __webpack_require__) {
            ...
            var InlineBlot1 = function(_super) {
                ...
                InlineBlot.prototype.optimize = function(context) {
                    ...
                    if (Object.keys(formats).length === 0) return this.unwrap(); // unformatted span
                    var next = this.next;
        ...
        function(module, exports, __webpack_require__) {
            ...
            var format_1 = __webpack_require__(18);
            var Registry = __webpack_require__(1);
            var BlockBlot1 = function(_super) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var leaf_1 = __webpack_require__(19);
            var EmbedBlot1 = function(_super) {
 ...
 */ function diff_halfMatch_(text1, text2) {
                var longtext1 = text1.length > text2.length ? text1 : text2;
                var shorttext1 = text1.length > text2.length ? text2 : text1;
                if (longtext1.length < 4 || shorttext1.length * 2 < longtext1.length) return null; // Pointless.
                /**
   ...
   */ function diff_halfMatchI_(longtext, shorttext, i) {
                ...
                var hm1 = diff_halfMatchI_(longtext1, shorttext1, Math.ceil(longtext1.length / 4));
                // Check again based on the third quarter.
                var hm2 = diff_halfMatchI_(longtext1, shorttext1, Math.ceil(longtext1.length / 2));
                var hm;
                ...
                while(pointer < diffs.length)switch(diffs[pointer][0]){
                    ...
                    case DIFF_EQUAL:
                        ...
                        if (count_delete + count_insert > 1) {
                            ...
                            if (count_delete === 0) diffs.splice(pointer - count_insert, count_delete + count_insert, [
                                DIFF_INSERT,
                                text_insert
                            ]);
                            else if (count_insert === 0) diffs.splice(pointer - count_delete, count_delete + count_insert, [
                                DIFF_DELETE,
                                text_delete
                            ]);
                            else diffs.splice(pointer - count_delete - count_insert, count_delete + count_insert, [
                                DIFF_DELETE,
                                text_delete
                            ], [
                                DIFF_INSERT,
 ...
 */ function fix_cursor(diffs, cursor_pos) {
                ...
                if (d == null) // Text was deleted from end of original string,
                // cursor is now out of bounds in new string
                return diffs;
                else if (d[0] !== DIFF_EQUAL) // A modification happened at the cursor location.
                ...
                return diffs;
                    ...
                    if (d_next != null && d[1] + d_next[1] === d_next[1] + d[1]) {
                        ...
                        if (suffix.length > 0) ndiffs.splice(cursor_pointer + 2, 0, [
                            d_next[0],
                            suffix
                        ]);
                        return merge_tuples(ndiffs, cursor_pointer, 3);
                    } else // Not possible to perform any modification
                    return diffs;
                }
            }
            /*
 ...
 */ function merge_tuples(diffs, start, length) {
                ...
                for(var i = start + length - 1; i >= 0 && i >= start - 1; i--)if (i + 1 < diffs.length) {
                    ...
                    if (left_d[0] === right_d[1]) diffs.splice(i, 2, [
                        left_d[0],
                        left_d[1] + right_d[1]
                    ]);
                }
 ...
 */ EventEmitter.prototype.removeAllListeners = function removeAllListeners(event) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Clipboard1 = function(_Module) {
                    ...
                    },
                    {
                        ...
                        value: function convert(html) {
                            ...
                            if (formats[_code2.default.blotName]) {
                                ...
                                this.container.innerHTML = '';
                                return new _quillDelta2.default().insert(text, _defineProperty({
            ...
            function traverse(node, elementMatchers, textMatchers) {
                ...
                if (node.nodeType === node.TEXT_NODE) return textMatchers.reduce(function(delta, matcher) {
                    ...
                    var childrenDelta1 = traverse(childNode, elementMatchers, textMatchers);
                    if (childNode.nodeType === node.ELEMENT_NODE) {
                        childrenDelta1 = elementMatchers.reduce(function(childrenDelta, matcher) {
                            return matcher(childNode, childrenDelta);
                        }, childrenDelta1);
                        childrenDelta1 = (childNode[DOM_KEY] || []).reduce(function(childrenDelta, matcher) {
                            return matcher(childNode, childrenDelta);
                        }, childrenDelta1);
                    }
                    return delta.concat(childrenDelta1);
                }, new _quillDelta2.default());
            ...
            function matchIndent(node, delta) {
                ...
                while(!parent.classList.contains('ql-clipboard')){
                    if ((_parchment2.default.query(parent) || {
                    }).blotName === 'list') indent += 1;
                        ...
                        value: function attach(input) {
                            ...
                            input.addEventListener(eventName, function(e) {
                                ...
                                if (_this2.handlers[format] != null) _this2.handlers[format].call(_this2, value);
                                    ...
                                    if (!value) return;
                                    _this2.quill.updateContents(new _quillDelta2.default().retain(range.index).delete(range.length).insert(_defineProperty({
                                    }, format, value)), _quill2.default.sources.USER);
                        ...
                        value: function update(range) {
                            ...
                            this.controls.forEach(function(pair) {
                                ...
                                if (input.tagName === 'SELECT') {
                                    ...
                                    if (range == null) input.classList.remove('ql-active');
            ...
            Toolbar1.DEFAULTS = {
                ...
                handlers: {
                    ...
                    list: function list(value) {
                        ...
                        var formats = this.quill.getFormat(range);
                        if (value === 'check') {
                            if (formats['list'] === 'checked' || formats['list'] === 'unchecked') this.quill.format('list', false, _quill2.default.sources.USER);
        ...
        function(module, exports, __webpack_require__) {
            ...
            var ColorPicker1 = function(_Picker) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var IconPicker1 = function(_Picker) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var SnowTheme1 = function(_BaseTheme) {
                ...
                _createClass(SnowTheme, [
                    {
                        ...
                        value: function extendToolbar(toolbar) {
                            ...
                            this.tooltip = new SnowTooltip1(this.quill, this.options.bounds);
            ...
            SnowTheme1.DEFAULTS = (0, _extend2.default)(true, {
            ...
            var SnowTooltip1 = function(_BaseTooltip) {
            ...
            SnowTooltip1.TEMPLATE = [
                '<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a>',
                '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">',
                '<a class="ql-action"></a>',
                '<a class="ql-remove"></a>'
            ].join('');
            exports.default = SnowTheme1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var IdentAttributor1 = function(_Parchment$Attributor) {
            ...
            var IndentClass = new IdentAttributor1('indent', 'ql-indent', {
                scope: _parchment2.default.Scope.BLOCK,
                whitelist: [
                    1,
                    2,
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Blockquote1 = function(_Block) {
            ...
            Blockquote1.blotName = 'blockquote';
            Blockquote1.tagName = 'blockquote';
            exports.default = Blockquote1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
        ...
        function(module, exports, __webpack_require__) {
                ...
                _createClass(ListItem, [
                    {
                        key: 'format',
                        value: function format(name, value) {
                            if (name === List1.blotName && !value) this.replaceWith(_parchment2.default.create(this.statics.scope));
            ...
            ListItem1.blotName = 'list-item';
            ListItem1.tagName = 'LI';
            var List1 = function(_Container) {
                ...
                _createClass(List, [
                    ...
                    },
                    {
                        key: 'insertBefore',
                        value: function insertBefore(blot, ref) {
                            if (blot instanceof ListItem1) _get(List.prototype.__proto__ || Object.getPrototypeOf(List.prototype), 'insertBefore', this).call(this, blot, ref);
                            else {
            ...
            List1.blotName = 'list';
            List1.scope = _parchment2.default.Scope.BLOCK_BLOT;
            List1.tagName = [
                'OL',
                'UL'
            ];
            List1.defaultChild = 'list-item';
            List1.allowedChildren = [
                ListItem1
            ];
        ...
        function(module, exports, __webpack_require__) {
            ...
            Italic1.blotName = 'italic';
            Italic1.tagName = [
                'EM',
                'I'
            ];
            exports.default = Italic1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
        ...
        function(module, exports, __webpack_require__) {
            ...
            Strike1.blotName = 'strike';
            Strike1.tagName = 'S';
            exports.default = Strike1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
            ...
            var Underline1 = function(_Inline) {
            ...
            Underline1.blotName = 'underline';
            Underline1.tagName = 'U';
            exports.default = Underline1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
            ...
            var Image1 = function(_Parchment$Embed) {
                ...
                _createClass(Image, [
                    ...
                    {
                        key: 'formats',
                        value: function formats1(domNode) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Video1 = function(_BlockEmbed) {
            ...
            Video1.blotName = 'video';
            Video1.className = 'ql-video';
            Video1.tagName = 'IFRAME';
            exports.default = Video1;
        /***/ },
        function(module, exports, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
            ...
            var FormulaBlot1 = function(_Embed) {
            ...
            FormulaBlot1.blotName = 'formula';
            FormulaBlot1.className = 'ql-formula';
            FormulaBlot1.tagName = 'SPAN';
            var Formula1 = function(_Module) {
                _inherits(Formula, _Module);
                _createClass(Formula, null, [
                    {
                        key: 'register',
                        value: function register() {
                            _quill2.default.register(FormulaBlot1, true);
                        }
                    }
                ]);
                function Formula() {
            ...
            exports.FormulaBlot = FormulaBlot1;
        ...
        function(module, exports, __webpack_require__) {
            ...
            var SyntaxCodeBlock1 = function(_CodeBlock) {
            ...
            SyntaxCodeBlock1.className = 'ql-syntax';
            var CodeToken = new _parchment2.default.Attributor.Class('token', 'hljs', {
                scope: _parchment2.default.Scope.INLINE
            });
            var Syntax1 = function(_Module) {
                ...
                _createClass(Syntax, null, [
                    {
                        ...
                        value: function register() {
                            ...
                            _quill2.default.register(SyntaxCodeBlock1, true);
                        }
                    }
                ]);
                ...
                _createClass(Syntax, [
                    {
                        ...
                        value: function highlight() {
                            ...
                            this.quill.update(_quill2.default.sources.USER);
                            var range = this.quill.getSelection();
                            this.quill.scroll.descendants(SyntaxCodeBlock1).forEach(function(code) {
            ...
            exports.CodeBlock = SyntaxCodeBlock1;
            exports.CodeToken = CodeToken;
            exports.default = Syntax1;
        /***/ },
        function(module, exports) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var BubbleTheme1 = function(_BaseTheme) {
                ...
                _createClass(BubbleTheme, [
                    {
                        key: 'extendToolbar',
                        value: function extendToolbar(toolbar) {
                            this.tooltip = new BubbleTooltip1(this.quill, this.options.bounds);
            ...
            BubbleTheme1.DEFAULTS = (0, _extend2.default)(true, {
            }, _base2.default.DEFAULTS, {
                modules: {
                    toolbar: {
                        handlers: {
            ...
            var BubbleTooltip1 = function(_BaseTooltip) {
            ...
            exports.BubbleTooltip = BubbleTooltip1;
            exports.default = BubbleTheme1;
        /***/ },
        function(module, exports, __webpack_require__) {
...
},{}],"1GvOx":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$eb4d = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$eb4d.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NotesToolbar", ()=>NotesToolbar
);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
...
const NotesToolbar = ({ editorRef  })=>{
    ...
    const handleChangeFontSize = (num)=>{
        ...
        setTimeout(()=>fontSizeDisplay.classList.remove('font-size-display--animate')
        , 750);
    };
    ...
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
        ...
        children: [
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                className: "toolbar-segment quill-controls",
                children: [
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                                ...
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 34,
                                columnNumber: 21
                            }, undefined),
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                    ...
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        className: "ql-formats toolbar-color-selection",
                        children: [
                    ...
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        ...
                        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                            ...
                            children: _iconsDefault.default.capitalize
                        }, void 0, false, {
                            fileName: "src/js/components/NotesToolbar.js",
                            lineNumber: 60,
                            columnNumber: 21
            ...
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                className: "toolbar-segment custom-buttons",
                children: [
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        className: "ql-formats view-container",
                        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                            className: "ql-view",
                            ...
                            children: [
                                " ",
                                state.showShortcuts ? /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                                    children: "\xab NOTES"
                                }, void 0, false, {
                                    fileName: "src/js/components/NotesToolbar.js",
                                    lineNumber: 72,
                                    columnNumber: 27
                                }, undefined) : /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                                    children: "SHORTCUTS \xbb"
                                }, void 0, false, {
                                    fileName: "src/js/components/NotesToolbar.js",
                                    lineNumber: 73,
                                    columnNumber: 27
                    ...
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                                ...
                                ,
                                children: _iconsDefault.default.caretDown
                            }, void 0, false, {
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 78,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                                ...
                                onClick: ()=>handleChangeFontSize(2)
                                ,
                                children: _iconsDefault.default.caretUp
                            }, void 0, false, {
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 83,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                        className: "ql-formats copy-container",
                        children: [
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("button", {
                                className: "ql-copy",
                                onClick: (e)=>_clipboard.handleCopyFullText(editorRef)
                                ,
                                children: _iconsDefault.default.copy
                            }, void 0, false, {
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 90,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                                ...
                                children: _iconsDefault.default.clipboard
                            }, void 0, false, {
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 95,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
                                ...
                                children: `Font size: ${state.editorFontSize}`
                            }, void 0, false, {
                                fileName: "src/js/components/NotesToolbar.js",
                                lineNumber: 96,
                                columnNumber: 21
...
_s(NotesToolbar, "DsI0EtFrxyT1Ue72PawTIqn7i3k=");
_c = NotesToolbar;
var _c;
$RefreshReg$(_c, "NotesToolbar");

  $parcel$ReactRefreshHelpers$eb4d.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","../context/StateContext":"W4FOM","../utils/Clipboard":"db1SM","../icons/icons":"hjt0E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"db1SM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// https://github.com/quilljs/quill/issues/1184
// make the pasted content plain text
parcelHelpers.export(exports, "PlainClipboard", ()=>PlainClipboard
);
parcelHelpers.export(exports, "handleCopyFullText", ()=>handleCopyFullText
);
parcelHelpers.export(exports, "handleCopyTextSelection", ()=>handleCopyTextSelection
);
parcelHelpers.export(exports, "handleCutTextSelection", ()=>handleCutTextSelection
);
// for making sure all copy and cut actions are plain text
var _reactQuill = require("react-quill");
const Clipboard = _reactQuill.Quill.import('modules/clipboard');
...
const handleCopyFullText = (editorRef)=>{
...
const handleCopyTextSelection = (editorRef)=>{
    const { text  } = getSelectionFromEditor(editorRef);
    // copy to clipboard
    copyTextToClipboard(text);
};
const handleCutTextSelection = (editorRef)=>{
...
const copyTextToClipboard = async (text)=>{
    try {
        ...
        setTimeout(()=>copyIcon.classList.remove('copied-icon--animate')
        , 750);
    } catch (error) {
...
},{"react-quill":"kyGm9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dlvZq":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$c62b = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$c62b.prelude(module);
...
var _addSnippetDefault = parcelHelpers.interopDefault(_addSnippet);
var _stateContext = require("../context/StateContext");
var _s = $RefreshSig$();
const Shortcuts = ({ snippets , customSnippets  })=>{
    _s();
    const { state , notesDispatch  } = _react.useContext(_stateContext.StateContext);
        ...
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
            ...
            children: [
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("h3", {
                    className: "snippets-header",
                    children: "Team Snippets"
                }, void 0, false, {
                    fileName: "src/js/components/Shortcuts.js",
                    lineNumber: 23,
                    columnNumber: 13
                }, undefined),
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    ...
                    children: [
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                            className: "shortcut-text shortcut-header",
                        ...
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                            className: "snippet-text snippet-header",
                            children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("strong", {
                                children: "Snippet"
                            }, void 0, false, {
                                fileName: "src/js/components/Shortcuts.js",
                ...
                !customSnippets?.snippets || !customSnippets?.snippets?.length ? /*#__PURE__*/ _jsxDevRuntime.jsxDEV("h3", {
                    className: "no-snippets-message",
                    children: "You have no custom snippets. Add one!"
                }, void 0, false, {
                    fileName: "src/js/components/Shortcuts.js",
                    lineNumber: 61,
                    columnNumber: 21
                }, undefined) : customSnippets?.snippets?.map((snippet)=>{
                    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                ...
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_addSnippetDefault.default, {
                }, void 0, false, {
                    fileName: "src/js/components/Shortcuts.js",
                    lineNumber: 90,
                    columnNumber: 13
...
_s(Shortcuts, "DsI0EtFrxyT1Ue72PawTIqn7i3k=");
_c = Shortcuts;
var _c;
$RefreshReg$(_c, "Shortcuts");

  $parcel$ReactRefreshHelpers$c62b.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","./AddSnippet":"69iD2","../context/StateContext":"W4FOM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"69iD2":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$b230 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$b230.prelude(module);
...
function AddSnippet() {
    _s();
    const { state , notesDispatch  } = _react.useContext(_stateContext.StateContext);
    const [shortcut, setShortcut] = _react.useState('');
    ...
    const handleSubmit = ()=>{
        if (shortcut && text) {
            ...
            if (shortcutExists) {
                _reactNotifications.NotificationManager.warning('Choose another shortcut', 'Shortcut exists!', 2000);
                return;
            }
            // set local storage
            localStorage.setItem('dou_custom_snippets', JSON.stringify({
        ...
        } else _reactNotifications.NotificationManager.warning('Enter a shortcut and text', 'Information needed!', 2000);
    };
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV(_jsxDevRuntime.Fragment, {
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
            className: "add-shortcut-container",
            children: [
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    ...
                    fileName: "src/js/components/AddSnippet.js",
                    lineNumber: 48,
                    columnNumber: 13
                }, this),
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
...
_s(AddSnippet, "E1qBUDD9oZgdSLnGjh5j3xRRvv4=");
_c = AddSnippet;
var _c;
$RefreshReg$(_c, "AddSnippet");

  $parcel$ReactRefreshHelpers$b230.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","../context/StateContext":"W4FOM","react-notifications":"bJ8Af","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"ivZGd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "typeArray", ()=>typeArray
);
parcelHelpers.export(exports, "typingTimer", ()=>typingTimer
);
parcelHelpers.export(exports, "typingTimeout", ()=>typingTimeout
);
parcelHelpers.export(exports, "trackTyping", ()=>trackTyping
);
parcelHelpers.export(exports, "clearTypingTimer", ()=>clearTypingTimer
);
parcelHelpers.export(exports, "clearTypeArray", ()=>clearTypeArray
);
var _checkShortcuts = require("./checkShortcuts");
let typeArray = []; // what's typed
let typingTimer; // time between keypresses
let typingTimeout = 750; // Delay before array cleared
const trackTyping = (e, editorRef, snippets, customSnippets)=>{
    ...
    if (key === 'Tab' || key === 'Enter' || key === ' ') return clearTypeArray();
    ...
    if (key.length === 1) {
        ...
        _checkShortcuts.checkShortcuts(typeArray.join(''), editorRef, snippets, customSnippets);
    }
};
...
const clearTypeArray = (e)=>{
    clearTypingTimer();
    typeArray.length = [];
};

},{"./checkShortcuts":"8ZrJg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ZrJg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkShortcuts", ()=>checkShortcuts
);
var _changeText = require("./changeText");
const checkShortcuts = (letterArray, editorRef, snippets, customSnippets)=>{
    const mySnippets = [
        ...snippets.snippets,
    ...
    if (snippet) _changeText.insertSnippet(snippet.text, letterArray, editorRef);
};

},{"./changeText":"bvasa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bvasa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "insertSnippet", ()=>insertSnippet
);
parcelHelpers.export(exports, "formatPhoneNumber", ()=>formatPhoneNumber
);
parcelHelpers.export(exports, "handleCapitalizeText", ()=>handleCapitalizeText
);
var _trackTyping = require("./trackTyping");
const insertSnippet = (snippet, shortcut, editorRef)=>{
    ...
    _trackTyping.clearTypeArray();
};
const formatPhoneNumber = (e, editorRef)=>{
    editorRef = editorRef.current;
...
const handleCapitalizeText = function() {
    // get the selection index and length
    ...
    if (selectedText == selectedText.toUpperCase()) newText = selectedText.toLowerCase();
...
},{"./trackTyping":"ivZGd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iWzMk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"react-notifications/lib/NotificationManager":"e5lRA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kn9T2","edn9Z"], null, "parcelRequire630b")

//# sourceMappingURL=Notes.e784119e.js.map
